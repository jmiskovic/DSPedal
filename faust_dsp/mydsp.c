...
void metadatamydsp(MetaGlue* m) { 
	...
	m->declare(m->mInterface, "copyright", "(c) GRAME 2006");
	m->declare(m->mInterface, "license", "BSD");
	m->declare(m->mInterface, "name", "freeverb");
	m->declare(m->mInterface, "reference", "https://ccrma.stanford.edu/~jos/pasp/Freeverb.html");
...
void buildUserInterfacemydsp(mydsp* dsp, UIGlue* interface) {
	interface->openVerticalBox(interface->uiInterface, "Freeverb");
	interface->addHorizontalSlider(interface->uiInterface, "Damp", &dsp->fHslider2, 0.5f, 0.f, 1.f, 0.025f);
	interface->addHorizontalSlider(interface->uiInterface, "RoomSize", &dsp->fHslider1, 0.5f, 0.f, 1.f, 0.025f);
	interface->addHorizontalSlider(interface->uiInterface, "Wet", &dsp->fHslider0, 0.3333f, 0.f, 1.f, 0.025f);
