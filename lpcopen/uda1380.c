...
int UDA1380_Init(int input)
{
	...
	/*UDA1380_REG_Write(0x01, 0x0010);
	UDA1380_REG_Write(0x02, 0xA4DF);
	UDA1380_REG_Write(0x03, 0x0000);
	UDA1380_REG_Write(0x04, 0x0202);
	UDA1380_REG_Write(0x10, 0x0000);
	UDA1380_REG_Write(0x11, 0x0000);
	UDA1380_REG_Write(0x12, 0x0000);
	UDA1380_REG_Write(0x13, 0x0303);
	UDA1380_REG_Write(0x14, 0x0040);
	UDA1380_REG_Write(0x20, 0x3030);
	UDA1380_REG_Write(0x21, 0x0F0F);
	UDA1380_REG_Write(0x22, 0x0001);
	UDA1380_REG_Write(0x23, 0x0000);
	UDA1380_REG_Write(0x00, 0x0F32);*/
